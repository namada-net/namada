...
use namada_core::masp::{CompactNote, MaspTxId};
...
/// A type representing the possible reference to some MASP data
...
pub enum MaspTxRef {
    ...
    /// Unencrypted notes generated by the protocol
    Unencrypted(Vec<CompactNote>),
}
